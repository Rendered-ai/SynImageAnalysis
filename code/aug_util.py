...
def get_bboxes(img, boxes, classes, output_dir, desired_classes=(32,54,49)):
    """
    A helper function to draw bounding box rectangles on images
    ...
    for i, b in enumerate(boxes):
        ...
        if label in desired_classes:
            cropped_source.save(output_dir+'img=_'+chip_name[:-4]+'_cls='+str(label)+"_time="+str(time())+".jpeg")
            count += 1
